...
class ClosestPatent extends StatefulWidget {
  List patents;

  ClosestPatent({this.patents});

  @override
  _ClosestPatentState createState() => _ClosestPatentState();
}

class _ClosestPatentState extends State<ClosestPatent> {
  bool isLoading = false;

  @override
  void initState() {
    print(widget.patents.length);
    super.initState();
  }
